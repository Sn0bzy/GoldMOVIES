...
<style>
.wrap_normal .movie_container .movie_image {
	width: auto;
}
.wrap_normal .movie_container .movie_information  {
	width: auto;
}
.movie_desc_content.float-none.description-of-movie {
    font-size: 18px;
    line-height: 20px;
}
		...
		<div class="post_description">
				...
				<div class="share-buttons v2" style="float: left;"><div class="share-container">
				  <div class="primary-shares nowhatsapp" style="margin-left: -5px;">
				    <a target="_blank" href="http://www.facebook.com/share.php?u=<?php echo home_url(); ?>/news/<?php echo $post->post_name; ?>" class="social-share facebook" style="text-decoration: none;">
				    ...
				    <a target="_blank" href="http://twitter.com/share?url=<?php echo home_url(); ?>/news/<?php echo $post->post_name; ?>&amp;text=<?php echo $post->post_title; ?>" class="social-share twitter" style="text-decoration: none;">
					  <svg style="fill: #fff; width: 23px; position: relative; top: 9px; margin: 0px 7px 0px 5px;" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
				    ...
				    <a target="_blank" href="https://plus.google.com/share?url=<?php echo home_url(); ?>/news/<?php echo $post->post_name; ?>" class="social-share google" style="text-decoration: none;">
				      ...
				      <span class="expanded-text">Google</span>
						...
						<div class="movie_description">
							<div class="movie_desc_row desc-info">
								<div class="movie_desc_content float-none description-of-movie"><?php echo the_content(); ?></div>
							</div>
						</div>
					</div>
				</div>
