  ...
  class OT_Settings {
            ...
            echo '<div class="wrap settings-wrap" id ="page-' . $page['id'] . '">';
              ...
              echo '<div id="option-tree-header-wrap">';
                ...
                echo '<ul id="option-tree-header">';
                  ...
                  echo '<li id="option-tree-logo">' . apply_filters( 'ot_header_logo_link', '<a class="ot-icon-youtube-play" href="">OptionTree</a>', $page['id'] ) . '</li>';
                  
                  echo '<li id="option-tree-version"><span>' . apply_filters( 'ot_header_version_text', 'Gold MOVIES Settings ', $page['id'] ) . '</span></li>';
                ...
                /* layouts form */
                if ( $page['id'] == 'ot_theme_options' && OT_SHOW_NEW_LAYOUT == false )
    ...
    public function display_setting( $args = array() ) {
      ...
      $_args = array(
        ...
        'field_rows'        => isset( $rows ) && ! empty( $rows ) ? $rows : 5,
